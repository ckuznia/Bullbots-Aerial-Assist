...
public class RobotMap {
    ...
    public static void init() {
        ...
        REAL CODE IS BELOW... ABOVE IS FOR TESTING 
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        driveJags1 = new DualJaguar(5, 6, defaultP, defaultI, defaultD);  // Real Robot: 1, 2  Second Robot: 5, 6
        driveJags2 = new DualJaguar(3, 4, defaultP, defaultI, defaultD);  // Real Robot: 3, 4  Second Robot: 3, 4
        winchJags = new Winch(1, 2, defaultP, defaultI, defaultD);        // Real Robot: 6, 5  Second Robot: 1, 2
