...
public class RobotMap {
    ...
    public static PIDController shooterAnglePIDSystem;
    ...
    public static DualJaguar driveJags1, driveJags2, winchJags;
	...
	LiveWindow.addActuator("Shooter", "angleMotor", (Victor) shooterangleMotor);
        ...
        shooterAnglePIDSystem = new PIDController(1.0, 0.0, 0.0, 0.0, shooterpotentiometer, shooterangleMotor, 0.02);
	LiveWindow.addActuator("Shooter", "AnglePIDSystem", shooterAnglePIDSystem);
        shooterAnglePIDSystem.setContinuous(false); shooterAnglePIDSystem.setAbsoluteTolerance(0.2); 
        shooterAnglePIDSystem.setOutputRange(-1.0, 1.0);        
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        winchJags = new DualJaguar(6, 5, 0.5, 0.0, 0.05);
