...
public class DriveTrain {
    ...
    public void checkState() {
        ...
        if(Robot.oi.joystickController1.isButtonDown(Robot.DRIVE_NORMAL_BUTTON) || 
                Robot.oi.joystickController2.isButtonDown(Robot.DRIVE_NORMAL_BUTTON)) {
            isInverted = false;
            // Making the speed value positive
            Robot.currentSpeed = Robot.MAX_POS_RPM;
        }
        else if(Robot.oi.joystickController1.isButtonDown(Robot.DRIVE_INVERTED_BUTTON) || 
                Robot.oi.joystickController2.isButtonDown(Robot.DRIVE_INVERTED_BUTTON)) {
            isInverted = true;
